...
export class StudyDirectionController {
  constructor(private readonly studydirectionService: StudyDirectionService) {}

  @Post()
  async create(
    @Body() createStudyDirectionDto: CreateStudyDirectionDto,
  ...
  @Get(':id')
  async findOneById(
    @Param('id') studydirectionId: number,
  ): Promise<StudyDirectionEntity> {
  ...
  async update(
    @Param('id') studydirectionId: number,
    @Body() updateStudyDirectionDto: UpdateStudyDirectionDto,
  ): Promise<StudyDirectionEntity> {
    return await this.studydirectionService.updateOne(
      studydirectionId,
      updateStudyDirectionDto,
    );
  }
