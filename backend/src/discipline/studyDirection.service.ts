...
export class StudyDirectionService {
    ...
    async create(studydirection: CreateStudyDirectionDto): Promise<StudyDirectionEntity> {
    ...
    async updateOne(studydirectionId: number, updateStudyDirection: DeepPartial<UpdateStudyDirectionDto>): Promise<StudyDirectionEntity> {
