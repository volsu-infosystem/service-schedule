...
export class AdmissionYearService {
    ...
    async create(admissionYear: CreateAdmissionYearDto): Promise<AdmissionYearEntity> {
    ...
    async updateOne(admissionYearId: number, updateAdmissionYear: DeepPartial<UpdateAdmissionYearDto>): Promise<AdmissionYearEntity> {
        await this.admissionYearRepository.update({id: admissionYearId}, updateAdmissionYear);
        const updatedAdmissionYear = await this.admissionYearRepository.findOne(admissionYearId);
    ...
    async deleteOne(admissionYearId: number): Promise<AdmissionYearEntity[]> {
        const admissionYearToRemove = await this.admissionYearRepository.find({id: admissionYearId});
