...
export type CreateProfileDto = CreateProfileStudentDto | CreateProfileProfessorDto
export type UpdateProfileDto = UpdateProfileStudentDto | UpdateProfileProfessorDto
